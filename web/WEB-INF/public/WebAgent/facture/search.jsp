            ...
            <bs:panel>
                <table class="table table-hover table-condensed table-responsive table-bordered  table-striped">
                    <thead>
                        <tr>
                            <td></td>
                            <td><language:language message="costumer"/></td>
                            <td><language:language message="type"/></td>
                            ...
                            <tr>
                                ...
                                <td style="width: 100px;">
                                    <form class="form-show" method="POST">
                                        ...
                                        <button class="btn btn-primary btn-xs btn-block"><span class="fa fa-eye"></span></button>
                                    </form>
                                </td>
                                <td style="width: 100px;">
