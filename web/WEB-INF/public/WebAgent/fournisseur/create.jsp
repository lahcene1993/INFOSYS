...
<bs:modal id="client">
    <form method="POST" action="" class="row">
        ...
        <div class="col-xs-6">
            ...
            <input type="text" name="identifiantFiscal" value="${entity.identifiantFiscal}" required class="form-control" >
        </div>
        <div class="col-xs-6">
        ...
        <div class="col-xs-6">
            ...
            <label>Faxe</label>
            <input type="text" pattern="^(?:0|\(?\+[1-9]*\)?\s?|00[1-9]*\s?)[1-99](?:[\.\-\s]?\d\d){4}$" name="fax" value="${entity.fax}" class="form-control">
        </div>
